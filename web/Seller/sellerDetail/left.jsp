...
<head>
	...
	<script type="text/javascript">
		...
		function hrefclick() {
			$.ajax({
				   type: "POST",
				   url: "http://10.65.245.136:8080/showAccount",
				   data: "AccountName=www",
	    ...
	    <li class="level1">
            ...
            <ul class="MenuLevel2">
            	<!--<li class="level2 level2Style">
                    <a target="right" href="boardList.html" style="font-size: 15px;">餐桌管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="cuisineList.html" style="font-size: 15px;">菜系管理</a>
				</li>-->
                <li class="level2 level2Style">
                	<form id="myform" method="post" action="http://10.65.245.136:8080/showAccount?AccountName=www">
                	<a target="right" href="salesmanOrderList.jsp" onclick="document.getElementById('myform').submit();" style="font-size: 15px;">订单管理</a>
					
					</form>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="fundManagement.jsp" style="font-size: 15px;">资金管理</a>
				</li>
